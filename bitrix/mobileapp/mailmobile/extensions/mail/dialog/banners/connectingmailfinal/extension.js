/**
 * @module mail/dialog/banners/connectingmailfinal
 */
jn.define('mail/dialog/banners/connectingmailfinal', (require, exports, module) => {
	...
	class ConnectingMailFinal extends LayoutComponent
	{
		constructor(props)
		{
			super(props);
		...
		messageLoadingScreen()
		{
			return View(
				...
				StatusBlock({
					...
					title: Loc.getMessage('MAIL_CONNECTING_FINAL_MAIL_BANNER_SYNCHRONIZE_TITLE'),
					description: Loc.getMessage('MAIL_CONNECTING_FINAL_MAIL_BANNER_SYNCHRONIZE_DESCRIPTION'),
				}),
			);
		}
		...
		render()
		{
			if (this.state.waitingForLoading)
			{
				return this.messageLoadingScreen();
			}

			return BannerTemplate({
				iconPathName: 'mailbox-connection-final-full-2.png',
				iconWidth: '125',
				iconHeight: '163',
	...
	module.exports = { ConnectingMailFinal };
});