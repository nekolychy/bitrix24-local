...
class WizardServices
{
	public static function GetTemplates($relativePath, $wizardRelativePath)
	{
		...
		while(($dirName = @readdir($handle)) !== false)
		{
			...
			if (file_exists($wizardAbsolutePath."/images/templates/".$dirName."/".LANGUAGE_ID."/screen.png"))
				$arTemplate["SCREENSHOT"] = $wizardRelativePath."/images/templates/".$dirName."/".LANGUAGE_ID."/screen.png";
			elseif (file_exists($wizardAbsolutePath."/images/templates/".$dirName."/screen.png"))
				$arTemplate["SCREENSHOT"] = $wizardRelativePath."/images/templates/".$dirName."/screen.png";
			else
				$arTemplate["SCREENSHOT"] = false;

			if (file_exists($wizardAbsolutePath."/images/templates/".$dirName."/preview.png"))
				$arTemplate["PREVIEW"] = $wizardRelativePath."/images/templates/".$dirName."/preview.png";
			else
