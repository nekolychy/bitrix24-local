...
if(WIZARD_FIRST_INSTAL !== "Y")
{
	...
	if ($groupId)
	{
		$SiteGroups["RATING_VOTE"] = $groupId;
	}

	$groupId = CGroup::GetIDByCode("RATING_VOTE_AUTHORITY");
	if ($groupId)
	{
		$SiteGroups["RATING_VOTE_AUTHORITY"] = $groupId;
	}
	...
	{
		$groupID = 	CGroup::GetIDByCode("EMPLOYEES_" . WIZARD_SITE_ID);

		if($groupID && WIZARD_SITE_DEPARTAMENT && \Bitrix\Main\Loader::includeModule('iblock'))
		{
