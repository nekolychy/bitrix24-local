...
(function (exports,main_popup,ui_buttons,main_core,ui_dialogs_messagebox) {
	...
	var ClientRegistration = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(ClientRegistration, [{
	    ...
	    value: function start() {
	      ...
	      var popup = new main_popup.Popup({
	        ...
	        buttons: [new ui_buttons.SaveButton({
	          text: main_core.Loc.getMessage('JS_B24_BOARDS_CLIENT_REGISTRATION_BUTTON'),
	    ...
	    value: function handleClickRegister(button, event) {
	      ...
	      loader.show();
	      main_core.ajax.runAction('disk.api.integration.b24boards.registerCloudClient', {
	        data: {
	...
	function _getServiceName2() {
	  return main_core.Extension.getSettings('disk.b24-boards-client-registration').get('serviceName');
	}
	...
	function _buildUsefulErrorText2(errors) {
	  ...
	  try {
	    for (_iterator.s(); !(_step = _iterator.n()).done;) {
	      ...
	      if (error.code === 'tariff_restriction') {
	        return main_core.Loc.getMessage('JS_B24_BOARDS_CLIENT_REGISTRATION_ERROR_AFTER_REG', {
	          '#NAME#': _classPrivateMethodGet(this, _getServiceName, _getServiceName2).call(this)
	        });
	      }
	      ...
	      if (error.code === 'domain_verification') {
	        return main_core.Loc.getMessage('JS_B24_BOARDS_CLIENT_REGISTRATION_ERROR_DOMAIN_VERIFICATION', {
	          '#NAME#': _classPrivateMethodGet(this, _getServiceName, _getServiceName2).call(this),
	  ...
	  return main_core.Loc.getMessage('JS_B24_BOARDS_CLIENT_REGISTRATION_ERROR_COMMON');
	}
	  ...
	  babelHelpers.createClass(ClientUnRegistration, [{
	    ...
	    value: function start() {
	      ...
	      this.messageBox = ui_dialogs_messagebox.MessageBox.create({
	        title: main_core.Loc.getMessage('JS_B24_BOARDS_CLIENT_UNREGISTRATION_TITLE', {
	          '#NAME#': _classPrivateMethodGet$1(this, _getServiceName$1, _getServiceName2$1).call(this)
	        }),
	        message: main_core.Loc.getMessage('JS_B24_BOARDS_CLIENT_UNREGISTRATION_MSG', {
	          '#NAME#': _classPrivateMethodGet$1(this, _getServiceName$1, _getServiceName2$1).call(this)
	        }),
	        buttons: BX.UI.Dialogs.MessageBoxButtons.OK_CANCEL,
	        okCaption: main_core.Loc.getMessage('JS_B24_BOARDS_CLIENT_UNREGISTRATION_UNREGISTER_BTN'),
	        onOk: function onOk() {
	          console.log(_this);
	    ...
	    value: function handleClickUnregister() {
	      var _this2 = this;
	      main_core.ajax.runAction('disk.api.integration.b24boards.unregisterCloudClient', {
	        data: {
	...
	function _buildUsefulErrorText2$1(errors) {
	  ...
	  return main_core.Loc.getMessage('JS_B24_BOARDS_CLIENT_UNREGISTRATION_ERROR_COMMON');
	}

	exports.ClientRegistration = ClientRegistration;
	exports.ClientUnRegistration = ClientUnRegistration;

}((this.BX.Disk.B24Boards = this.BX.Disk.B24Boards || {}),BX.Main,BX.UI,BX,BX.UI.Dialogs));
//# sourceMappingURL=disk.b24-boards-client-registration.bundle.js.map
