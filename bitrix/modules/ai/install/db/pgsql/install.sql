...
CREATE INDEX IF NOT EXISTS ix_b_ai_role_translate_desc_role_id ON b_ai_role_translate_description (ROLE_ID);
CREATE UNIQUE INDEX IF NOT EXISTS ux_b_ai_role_translate_desc_role_lang ON b_ai_role_translate_description (ROLE_ID, LANG);
