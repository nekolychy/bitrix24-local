...
CREATE TABLE IF NOT EXISTS b_hr_structure_user_settings
(
	ID BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS IX_B_HR_STRUCTURE_USER_SETTINGS
	ON b_hr_structure_user_settings (USER_ID, SETTINGS_TYPE);
