...
class CBPAbsenceVacationTrigger extends \Bitrix\Bizproc\Activity\BaseTrigger
{
	...
	protected static function getPropertiesMap(array $documentType, array $context = []): array
	{
		return [
			self::PARAM_USER_IDS => [
				'Name' => Loc::getMessage('TIMEMAN_ABSENCE_VACATION_TRIGGER_PROPERTY_USER_IDS'),
	...
	private static function makeEmptyError(string $property): array
	{
		return [
			...
			{
				self::PARAM_USER_IDS => Loc::getMessage('TIMEMAN_ABSENCE_VACATION_TRIGGER_PROPERTY_USER_IDS_EMPTY'),
				default => '',
			},
		];
	}
	...
	public function checkApplyRules(array $rules, TriggerParameters $parameters): Result
	{
		...
		if (!$this->checkUsersUseAbility($allowedUserIds, $userId))
		{
			return Result::createError(
				new Error(Loc::getMessage('TIMEMAN_ABSENCE_VACATION_TRIGGER_PROPERTY_USER_IDS_INCORRECT'))
			);
		}
