...
CREATE TABLE b_recyclebin_entity_uf (
  ID int8 GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  RECYCLEBIN_ID int8 NOT NULL,
  UF_ENTITY_ID varchar(50) NOT NULL,
  DATA text NOT NULL,
  PRIMARY KEY (ID)
);
CREATE INDEX ix_b_recyclebin_entity_uf_recyclebin_id ON b_recyclebin_entity_uf (recyclebin_id);
