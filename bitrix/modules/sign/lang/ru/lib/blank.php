...
$MESS['SIGN_CORE_BLANK_ERROR_FILE_TOO_BIG'] = 'Превышен размер файла, допустимый размер #SIZE#kb.';
$MESS['SIGN_FILE_BLANK_ERROR_TOO_MANY_PAGES'] = 'Превышено допустимое количество страниц (#COUNT#) в документе.';