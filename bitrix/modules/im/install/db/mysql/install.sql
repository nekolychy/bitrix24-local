...
(
	...
	`EVENT_LOG` char(1) NOT NULL DEFAULT 'N',
	PRIMARY KEY (`USER_ID`),
...
(
	...
	`EVENT_MODE` varchar(10) NOT NULL DEFAULT 'WEBHOOK',
	PRIMARY KEY `PK_B_IM_BOT` (`BOT_ID`),
	INDEX `IX_IM_BOT_1` (`APP_ID`),
	INDEX `IX_IM_BOT_2` (`CODE`)
);
...
(
	...
	`DATE_CREATE` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
	PRIMARY KEY (`ID`),
	KEY `IX_B_IM_EVENT_LOG_1` (`USER_ID`),
	KEY `IX_B_IM_EVENT_LOG_2` (`DATE_CREATE`)
);
