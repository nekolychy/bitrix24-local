...
CREATE INDEX ix_b_im_bot_app_id ON b_im_bot (app_id);
CREATE INDEX ix_b_im_bot_code ON b_im_bot (code);
...
CREATE INDEX ix_b_im_event_log_user_id ON b_im_event_log (user_id);
CREATE INDEX ix_b_im_event_log_date_create ON b_im_event_log (date_create);
