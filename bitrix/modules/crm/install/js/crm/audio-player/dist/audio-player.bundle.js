/* eslint-disable */
this.BX = this.BX || {};
(function (exports, main_core, ui_vue3, ui_vue3_components_audioplayer, main_core_events, ui_iconSet_api_core, ui_vue3_components_button) {
	'use strict';
	...
	const TranscriptionButton = {
		...
		computed: {
			...
			buttonStyle() {
				...
				return ui_vue3_components_button.AirButtonStyle.OUTLINE_ACCENT_2;
			}
		},
		methods: {
			handleClick() {
	...
	const AudioPlayerProps = {
		...
		watch: {
			transcriptionState(newValue) {
				this.currentTranscriptionState = newValue;
			}
		},
		methods: {
			onTranscriptionButtonClick() {
				if (this.currentTranscriptionState === TranscriptionState.pending || this.currentTranscriptionState === TranscriptionState.failed) {
					return;
				}
				...
				main_core_events.EventEmitter.emit('crm:audioplayer:transcript', data);
			},
...
})(this.BX.Crm = this.BX.Crm || {}, BX, BX.Vue3, BX.Vue3.Components, BX.Event, BX.UI.IconSet, BX.Vue3.Components);
