/* eslint-disable */
this.BX = this.BX || {};
(function (exports, main_core, main_popup, ui_buttons, main_core_events, ui_dialogs_messagebox) {
	'use strict';
	...
	class GridManager {
		...
		deleteDocument(documentId) {
			...
			ui_dialogs_messagebox.MessageBox.confirm(main_core.Loc.getMessage('DOCUMENT_GRID_DOCUMENT_DELETE_CONTENT_2'), (messageBox, button) => {
				button.setWaiting();
			...
			}, main_core.Loc.getMessage('DOCUMENT_GRID_DOCUMENT_DELETE_BUTTON_CONFIRM'), messageBox => messageBox.close(), main_core.Loc.getMessage('DOCUMENT_GRID_BUTTON_BACK'));
		}
		conductDocument(documentId) {
			...
			ui_dialogs_messagebox.MessageBox.confirm(main_core.Loc.getMessage('DOCUMENT_GRID_DOCUMENT_CONDUCT_CONTENT_2'), (messageBox, button) => {
				button.setWaiting();
			...
			}, main_core.Loc.getMessage('DOCUMENT_GRID_DOCUMENT_CONDUCT_BUTTON_CONFIRM'), messageBox => messageBox.close(), main_core.Loc.getMessage('DOCUMENT_GRID_BUTTON_BACK'));
		}
		cancelDocument(documentId) {
			...
			ui_dialogs_messagebox.MessageBox.confirm(main_core.Loc.getMessage('DOCUMENT_GRID_DOCUMENT_CANCEL_CONTENT_2'), (messageBox, button) => {
				button.setWaiting();
				main_core.ajax.runAction('crm.api.realizationdocument.setShipped', {
					data: {
						id: documentId,
			...
			}, main_core.Loc.getMessage('DOCUMENT_GRID_DOCUMENT_CANCEL_BUTTON_CONFIRM'), messageBox => messageBox.close(), main_core.Loc.getMessage('DOCUMENT_GRID_BUTTON_BACK'));
		}
...
})(this.BX.Crm = this.BX.Crm || {}, BX, BX.Main, BX.UI, BX.Event, BX.UI.Dialogs);
