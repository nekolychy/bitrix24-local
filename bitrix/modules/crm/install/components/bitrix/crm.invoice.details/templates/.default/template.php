...
if ($this->getComponent()->isRecurringItem())
{
	...
	$isRecurringTitle = Loc::getMessage('CRM_INVOICE_DETAIL_IS_RECURRING_ITEM_TITLE');
	$isRecurringDescription = Loc::getMessage('CRM_INVOICE_DETAIL_IS_RECURRING_ITEM_DESCRIPTION');
