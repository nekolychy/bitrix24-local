...
(function (exports,call_lib_callManager,im_public,im_v2_const,im_v2_lib_permission,main_core,im_v2_component_elements_button,im_v2_component_message_base,im_v2_component_message_elements,im_v2_lib_utils) {
	'use strict';
	...
	const CallInviteMessage = {
	  ...
	  computed: {
	    ...
	    isAvailable() {
	      if (this.$store.getters['recent/calls/hasActiveCall'](this.dialogId) && call_lib_callManager.CallManager.getInstance().getCurrentCallDialogId() === this.dialogId) {
	        return true;
	      }
	      if (this.$store.getters['recent/calls/hasActiveCall']()) {
	        return false;
	      }
	      const chatCanBeCalled = call_lib_callManager.CallManager.getInstance().chatCanBeCalled(this.dialogId);
...
}((this.BX.Call.Component = this.BX.Call.Component || {}),BX.Call.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Const,BX.Messenger.v2.Lib,BX,BX.Messenger.v2.Component.Elements,BX.Messenger.v2.Component.Message,BX.Messenger.v2.Component.Message,BX.Messenger.v2.Lib));
