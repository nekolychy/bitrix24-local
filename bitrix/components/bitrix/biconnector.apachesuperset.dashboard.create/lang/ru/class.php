...
$MESS['DASHBOARD_CREATE_FORM_SAVE_EMPTY_GROUPS'] = 'Выберите группу для создания отчёта';
$MESS['DASHBOARD_CREATE_FORM_ERROR'] = 'Не удалось создать отчёт. Попробуйте ещё раз';
$MESS['DASHBOARD_CREATE_FORM_EMPTY_TITLE_ERROR'] = 'Добавьте название отчёта';
$MESS['DASHBOARD_CREATE_FORM_SAVE_PARAMS_ERROR'] = 'Не удалось создать параметры отчёта. Откройте настройки отчёта и попробуйте ещё раз';
