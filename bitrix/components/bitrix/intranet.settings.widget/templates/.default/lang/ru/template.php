...
$MESS['INTRANET_SETTINGS_WIDGET_SPOTLIGHT_AFTER_CREATE_DESCRIPTION_MSGVER_1'] = 'Сейчас её видите только вы. Перейдите в <a href="/settings/configs/?page=mainpage">настройки</a>, чтобы отредактировать страницу и опубликовать для всех сотрудников';
