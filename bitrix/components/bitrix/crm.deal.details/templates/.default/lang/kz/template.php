...
$MESS["CRM_DEAL_DETAIL_IS_RECURRING_ITEM_DESCRIPTION"] = "CRM осы қалыптың баптауларын пайдаланады және автоматты түрде бапталған кесте бойынша мәмілелер жасайды";
$MESS["CRM_DEAL_DETAIL_IS_RECURRING_ITEM_TITLE"] = "Тұрақты мәміле қалыбы";
