...
$MESS['JS_B24_DOCUMENTS_CLIENT_UNREGISTRATION_TITLE'] = 'Отключение #NAME#';
$MESS['JS_B24_DOCUMENTS_CLIENT_UNREGISTRATION_MSG'] = 'Вы действительно хотите перестать использовать #NAME#? <br> При необходимости вы можете выполнить подключение заново. <br><br> Внимание: изменения во всех открытых документах могут не сохраниться. ';
$MESS['JS_B24_DOCUMENTS_CLIENT_UNREGISTRATION_UNREGISTER_BTN'] = 'Отключить';
$MESS['JS_B24_DOCUMENTS_CLIENT_UNREGISTRATION_ERROR_COMMON'] = 'Произошла ошибка, не удалось отменить регистрацию. Попробуйте позже.';