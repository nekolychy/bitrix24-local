	  ...
	  babelHelpers.createClass(PromoPopup, null, [{
	    ...
	    value: function showViewPromo() {
	      ...
	      ui_dialogs_messagebox.MessageBox.show({
	        title: this.canEdit() ? main_core.Loc.getMessage('JS_DISK_ONLYOFFICE_PROMO_EDIT_POPUP_TITLE') : main_core.Loc.getMessage('JS_DISK_ONLYOFFICE_PROMO_VIEW_POPUP_TITLE_MSGVER_1'),
	        message: content,
	        modal: true,
