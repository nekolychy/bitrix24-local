...
(function (exports, crm_entityEditor_field_fieldset, main_core_events, main_core) {
	...
	class EntityEditorBankDetailsField extends crm_entityEditor_field_fieldset.EntityEditorFieldsetField {
		getAddButton() {
			return main_core.Tag.render`
		<div class="ui-entity-editor-container-actions">
			<span>${main_core.Loc.getMessage('CRM_EDITOR_REQUISITE_BANK_DETAILS_ADD_LABEL')}</span><span> </span>
			<span class="ui-entity-editor-content-create-lnk" onclick="${this.onAddButtonClick.bind(this)}">${main_core.Loc.getMessage('CRM_EDITOR_REQUISITE_BANK_DETAILS_ADD_LINK_TEXT')}</span>
		</div>`;
		}
		onAddButtonClick() {
			this.addEmptyValue({
