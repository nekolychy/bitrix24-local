...
$MESS['CRM_TOOLBAR_COMPONENT_ROBOTS_GUIDE_TEXT_1'] = 'Настроить роботов и триггеры можно здесь';
$MESS['CRM_TOOLBAR_COMPONENT_SCRIPTS_GUIDE_TEXT'] = 'Настроить умные сценарии можно здесь';
$MESS['CRM_TOOLBAR_COMPONENT_TELEPHONY_NOT_SUPPORTED'] = 'Чтобы позвонить, нужно установить модуль Веб-мессенджер. Обратитесь к администратору вашего Битрикс24';
$MESS['CRM_TOOLBAR_COMPONENT_TELEPHONY_NOT_SUPPORTED_OK'] = 'Понятно';
...
$MESS['CRM_TOOLBAR_COMPONENT_ADD_CLIENT_FOR_CALL_INVOICE'] = 'Чтобы позвонить, добавьте в этот счёт клиента с номером телефона';
$MESS['CRM_TOOLBAR_COMPONENT_ADD_CLIENT_FOR_CALL_SMART_INVOICE'] = 'Чтобы позвонить, добавьте в этот счёт клиента с номером телефона';
...
$MESS['CRM_TOOLBAR_COMPONENT_ADD_CLIENT_FOR_EMAIL_SEND_INVOICE'] = 'Чтобы отправить письмо, добавьте в этот счёт клиента c e-mail';
$MESS['CRM_TOOLBAR_COMPONENT_ADD_CLIENT_FOR_EMAIL_SEND_SMART_INVOICE'] = 'Чтобы отправить письмо, добавьте в этот счёт клиента c e-mail';
$MESS['CRM_TOOLBAR_COMPONENT_ADD_CLIENT_FOR_EMAIL_SEND_QUOTE'] = 'Чтобы отправить письмо, добавьте в это предложение клиента c e-mail';
