...
(function (exports, crm_ai_nameService, crm_timeline_tools, main_core, main_core_events, main_date, ui_notification, ui_textEditor, ui_vue3, main_popup, ui_infoHelper, ui_analytics, location_core, location_widget, calendar_controls, calendar_planner, calendar_util, ui_designTokens, ui_entitySelector, calendar_sectionmanager, ui_sidepanel, crm_clientSelector, ui_uploader_tileWidget, crm_field_colorSelector, ui_vue3_directives_hint, crm_field_pingSelector) {
	...
	var _Analytics_brand = /*#__PURE__*/new WeakSet();
	let Analytics = /*#__PURE__*/function () {
		function Analytics(section, subSection) {
			babelHelpers.classCallCheck(this, Analytics);
			_classPrivateMethodInitSpec$4(this, _Analytics_brand);
			_classPrivateFieldInitSpec$4(this, _tool, 'crm');
			_classPrivateFieldInitSpec$4(this, _category, 'activity_operations');
			_classPrivateFieldInitSpec$4(this, _event, void 0);
			_classPrivateFieldInitSpec$4(this, _type, 'todo_activity');
			_classPrivateFieldInitSpec$4(this, _section, void 0);
			_classPrivateFieldInitSpec$4(this, _subSection, void 0);
			_classPrivateFieldInitSpec$4(this, _element, void 0);
			_classPrivateFieldInitSpec$4(this, _crmMode, void 0);
			_classPrivateFieldInitSpec$4(this, _pingSettings$1, void 0);
			_classPrivateFieldInitSpec$4(this, _colorId, void 0);
			_classPrivateFieldInitSpec$4(this, _blockTypes, void 0);
			_classPrivateFieldInitSpec$4(this, _notificationSkipPeriod, void 0);
			_classPrivateFieldInitSpec$4(this, _isTitleChanged, false);
			_classPrivateFieldInitSpec$4(this, _isDescriptionChanged, false);
			_classPrivateFieldInitSpec$4(this, _extensionSettings, null);
			_classPrivateFieldSet$4(_extensionSettings, this, main_core.Extension.getSettings('crm.activity.todo-editor-v2'));
			_classPrivateFieldSet$4(_section, this, section);
			_classPrivateFieldSet$4(_subSection, this, subSection);
			_classPrivateFieldSet$4(_crmMode, this, _assertClassBrand$4(_Analytics_brand, this, _getCrmMode).call(this));
		}
		return babelHelpers.createClass(Analytics, [{
			key: "setEvent",
			value: function setEvent(event) {
				_classPrivateFieldSet$4(_event, this, event);
				return this;
			}
		}, {
			key: "setSubSection",
			...
			value: function setPingSettings(pingSettings) {
				_classPrivateFieldSet$4(_pingSettings$1, this, pingSettings);
				return this;
			}
		}, {
			key: "setColorId",
			value: function setColorId(colorId) {
				_classPrivateFieldSet$4(_colorId, this, colorId);
				return this;
			}
		}, {
			key: "setBlockTypes",
			value: function setBlockTypes(blockTypes) {
				_classPrivateFieldSet$4(_blockTypes, this, blockTypes);
				return this;
			}
		}, {
			key: "setNotificationSkipPeriod",
			value: function setNotificationSkipPeriod(notificationSkipPeriod) {
				_classPrivateFieldSet$4(_notificationSkipPeriod, this, notificationSkipPeriod);
				return this;
			}
		}, {
			key: "setElement",
			value: function setElement(element) {
				_classPrivateFieldSet$4(_element, this, element);
				return this;
			}
		}, {
			key: "setIsTitleChanged",
			value: function setIsTitleChanged(value = true) {
				_classPrivateFieldSet$4(_isTitleChanged, this, value);
				return this;
			}
		}, {
			key: "setIsDescriptionChanged",
			value: function setIsDescriptionChanged(value = true) {
				_classPrivateFieldSet$4(_isDescriptionChanged, this, value);
				return this;
			}
		}, {
			key: "send",
			value: function send() {
				...
				if (_assertClassBrand$4(_Analytics_brand, this, _validate).call(this, data)) {
			...
			value: function getData() {
				const data = {
					tool: _classPrivateFieldGet$4(_tool, this),
					category: _classPrivateFieldGet$4(_category, this),
					event: _classPrivateFieldGet$4(_event, this),
					type: _classPrivateFieldGet$4(_type, this),
					c_section: _classPrivateFieldGet$4(_section, this),
					c_sub_section: _classPrivateFieldGet$4(_subSection, this),
					c_element: _classPrivateFieldGet$4(_element, this),
					p1: _classPrivateFieldGet$4(_crmMode, this)
				};
				if (main_core.Type.isStringFilled(_classPrivateFieldGet$4(_notificationSkipPeriod, this))) {
					if (_classPrivateFieldGet$4(_notificationSkipPeriod, this) === 'forever') {
						data.p2 = 'skipPeriod_custom';
					} else {
						data.p2 = 'skipPeriod_forever';
					}
				} else if (main_core.Type.isStringFilled(_classPrivateFieldGet$4(_pingSettings$1, this))) {
					data.p2 = 'ping_custom';
				}
				if (main_core.Type.isStringFilled(_classPrivateFieldGet$4(_colorId, this))) {
					data.p3 = 'color_custom';
				}
				if (main_core.Type.isArrayFilled(_classPrivateFieldGet$4(_blockTypes, this))) {
					const p4Items = [];
					if (_classPrivateFieldGet$4(_blockTypes, this).includes('section_calendar')) {
						p4Items.push('calendarCustom');
					}
					p4Items.push(`addBlock_${_classPrivateFieldGet$4(_blockTypes, this).length}`);
					data.p4 = p4Items.join(',');
				}
				const p5Items = [];
				if (_classPrivateFieldGet$4(_isTitleChanged, this)) {
					p5Items.push('title');
				}
				if (_classPrivateFieldGet$4(_isDescriptionChanged, this)) {
	...
	function _getCrmMode() {
		return `crmMode_${_classPrivateFieldGet$4(_extensionSettings, this).get('crmMode', '').toLowerCase()}`;
	}
	...
	var _InputPopup_brand$1 = /*#__PURE__*/new WeakSet();
	let InputPopup$1 = /*#__PURE__*/function () {
		function InputPopup(params) {
			babelHelpers.classCallCheck(this, InputPopup);
			_classPrivateMethodInitSpec$3(this, _InputPopup_brand$1);
			_classPrivateFieldInitSpec$3(this, _popup$1, null);
			_classPrivateFieldInitSpec$3(this, _bindElement$2, null);
			_classPrivateFieldInitSpec$3(this, _title$1, null);
			_classPrivateFieldInitSpec$3(this, _buttonTitle$1, null);
			_classPrivateFieldInitSpec$3(this, _onSubmit$1, null);
			_classPrivateFieldInitSpec$3(this, _address, null);
			_classPrivateFieldInitSpec$3(this, _addressFormatted, '');
			_classPrivateFieldInitSpec$3(this, _addressWidget, null);
			_classPrivateFieldInitSpec$3(this, _searchInput, null);
			_classPrivateFieldInitSpec$3(this, _detailsContainer, null);
			_classPrivateFieldInitSpec$3(this, _addressContainer, null);
			_classPrivateFieldSet$3(_bindElement$2, this, params.bindElement);
			_classPrivateFieldSet$3(_title$1, this, params.title);
			_classPrivateFieldSet$3(_buttonTitle$1, this, params.buttonTitle || 'OK');
			_classPrivateFieldSet$3(_address, this, main_core.Type.isStringFilled(params.addressJson) ? new location_core.Address(JSON.parse(params.addressJson)) : null);
			_classPrivateFieldSet$3(_addressFormatted, this, main_core.Type.isStringFilled(params.addressFormatted) ? params.addressFormatted : null);
			_classPrivateFieldSet$3(_onSubmit$1, this, params.onSubmit);
			this.onClickHandler = this.onClickHandler.bind(this);
			this.onKeyUpHandler = this.onKeyUpHandler.bind(this);
		}
		return babelHelpers.createClass(InputPopup, [{
			key: "show",
			value: function show() {
				_assertClassBrand$3(_InputPopup_brand$1, this, _getPopup$1).call(this).show();
				setTimeout(() => {
					_classPrivateFieldGet$3(_searchInput, this).focus();
				});
			}
		}, {
			key: "destroy",
			value: function destroy() {
				if (_classPrivateFieldGet$3(_popup$1, this)) {
					_classPrivateFieldGet$3(_popup$1, this).destroy();
				}
			}
		}, {
			key: "initAddress",
			value: function initAddress() {
				...
				_classPrivateFieldSet$3(_addressWidget, this, widgetFactory.createAddressWidget({
					address: _classPrivateFieldGet$3(_address, this),
					mode: location_core.ControlMode.edit
				}));
				_classPrivateFieldGet$3(_addressWidget, this).subscribeOnAddressChangedEvent(event => {
					const data = event.getData();
					_classPrivateFieldSet$3(_address, this, main_core.Type.isObject(data.address) ? data.address : null);
				});
				const addressWidgetParams = {
					mode: location_core.ControlMode.edit,
					inputNode: _classPrivateFieldGet$3(_searchInput, this),
					mapBindElement: _classPrivateFieldGet$3(_searchInput, this),
					fieldsContainer: _classPrivateFieldGet$3(_detailsContainer, this),
					controlWrapper: _classPrivateFieldGet$3(_addressContainer, this)
				};
				_classPrivateFieldGet$3(_addressWidget, this).render(addressWidgetParams);
				_assertClassBrand$3(_InputPopup_brand$1, this, _setFocus).call(this);
			}
		}, {
			key: "onClickHandler",
			value: function onClickHandler() {
				_assertClassBrand$3(_InputPopup_brand$1, this, _getPopup$1).call(this).close();
				_classPrivateFieldGet$3(_onSubmit$1, this).call(this, _classPrivateFieldGet$3(_address, this));
			}
		}, {
			key: "onKeyUpHandler",
	...
	function _getPopup$1() {
		if (!_classPrivateFieldGet$3(_popup$1, this)) {
			_classPrivateFieldSet$3(_popup$1, this, new main_popup.Popup({
				id: `crm-todo-address-input-popup-${main_core.Text.getRandom()}`,
				bindElement: _classPrivateFieldGet$3(_bindElement$2, this),
				content: _assertClassBrand$3(_InputPopup_brand$1, this, _getContent$1).call(this),
				closeByEsc: false,
				closeIcon: false,
				draggable: false,
				width: 466,
		...
		return _classPrivateFieldGet$3(_popup$1, this);
	}
	function _getContent$1() {
		_classPrivateFieldSet$3(_searchInput, this, main_core.Tag.render`
			<input 
				type="text" 
				class="ui-ctl-element ui-ctl-textbox crm-activity__todo-editor-v2_block-popup-address-input-container" 
				value="${_classPrivateFieldGet$3(_addressFormatted, this)}" 
			>
		`);
		_classPrivateFieldSet$3(_detailsContainer, this, main_core.Tag.render`<div class="location-fields-control-block"></div>`);
		_classPrivateFieldSet$3(_addressContainer, this, main_core.Tag.render`<div></div>`);
			...
			<div>
				<div class="crm-activity__todo-editor-v2_block-popup-wrapper --address">
					<div class="crm-activity__todo-editor-v2_block-popup-title">
						${main_core.Text.encode(_classPrivateFieldGet$3(_title$1, this))}
					</div>
					<div class="crm-activity__todo-editor-v2_block-popup-content">
						${_classPrivateFieldGet$3(_searchInput, this)}
						<button 
							onclick="${this.onClickHandler}" 
							class="ui-btn ui-btn-primary"
						>
							${main_core.Text.encode(_classPrivateFieldGet$3(_buttonTitle$1, this))}
						</button>
					</div>
					${_classPrivateFieldGet$3(_detailsContainer, this)}
					${_classPrivateFieldGet$3(_addressContainer, this)}
				</div>
			</div>
		`;
	}
	...
	var _InputPopup_brand = /*#__PURE__*/new WeakSet();
	let InputPopup = /*#__PURE__*/function () {
		function InputPopup(params) {
			babelHelpers.classCallCheck(this, InputPopup);
			_classPrivateMethodInitSpec$2(this, _InputPopup_brand);
			_classPrivateFieldInitSpec$2(this, _popup, null);
			_classPrivateFieldInitSpec$2(this, _bindElement$1, null);
			_classPrivateFieldInitSpec$2(this, _title, null);
			_classPrivateFieldInitSpec$2(this, _placeholder, null);
			_classPrivateFieldInitSpec$2(this, _buttonTitle, null);
			_classPrivateFieldInitSpec$2(this, _input, null);
			_classPrivateFieldInitSpec$2(this, _onSubmit, null);
			_classPrivateFieldSet$2(_bindElement$1, this, params.bindElement);
			_classPrivateFieldSet$2(_title, this, params.title);
			_classPrivateFieldSet$2(_placeholder, this, params.placeholder);
			_classPrivateFieldSet$2(_buttonTitle, this, params.buttonTitle || 'OK');
			_classPrivateFieldSet$2(_onSubmit, this, params.onSubmit);
			this.onClickHandler = this.onClickHandler.bind(this);
			this.onKeyUpHandler = this.onKeyUpHandler.bind(this);
		}
		return babelHelpers.createClass(InputPopup, [{
			key: "show",
			value: function show() {
				_assertClassBrand$2(_InputPopup_brand, this, _getPopup).call(this).show();
				setTimeout(() => {
					_classPrivateFieldGet$2(_input, this).focus();
				});
			}
		}, {
			key: "destroy",
			value: function destroy() {
				if (_classPrivateFieldGet$2(_popup, this)) {
					_classPrivateFieldGet$2(_popup, this).destroy();
				}
			}
		}, {
			key: "setValue",
			value: function setValue(value) {
				if (_classPrivateFieldGet$2(_input, this)) {
					_classPrivateFieldGet$2(_input, this).value = value;
				}
			}
		}, {
			key: "onClickHandler",
			value: function onClickHandler(event) {
				_assertClassBrand$2(_InputPopup_brand, this, _getPopup).call(this).close();
				_classPrivateFieldGet$2(_onSubmit, this).call(this, _classPrivateFieldGet$2(_input, this).value);
			}
		}, {
			key: "onKeyUpHandler",
			value: function onKeyUpHandler(event) {
	...
	function _getPopup() {
		if (!_classPrivateFieldGet$2(_popup, this)) {
			_classPrivateFieldSet$2(_popup, this, new main_popup.Popup({
				id: `crm-todo-link-input-popup-${main_core.Text.getRandom()}`,
				bindElement: _classPrivateFieldGet$2(_bindElement$1, this),
				content: _assertClassBrand$2(_InputPopup_brand, this, _getContent).call(this),
				closeByEsc: false,
				closeIcon: false,
				draggable: false,
				width: 466,
		...
		return _classPrivateFieldGet$2(_popup, this);
	}
	function _getContent() {
		_classPrivateFieldSet$2(_input, this, main_core.Tag.render`
			<input 
				type="text" 
				placeholder="${main_core.Text.encode(_classPrivateFieldGet$2(_placeholder, this))}"
		...
		return main_core.Tag.render`
			<div class="crm-activity__todo-editor-v2_block-popup-wrapper --link">
				<div class="crm-activity__todo-editor-v2_block-popup-title">
					${main_core.Text.encode(_classPrivateFieldGet$2(_title, this))}
				</div>
				<div class="crm-activity__todo-editor-v2_block-popup-content">
					${_classPrivateFieldGet$2(_input, this)}
					<button 
						onclick="${this.onClickHandler}" 
						class="ui-btn ui-btn-primary"
					>
						${main_core.Text.encode(_classPrivateFieldGet$2(_buttonTitle, this))}
					</button>
				</div>
			</div>
		`;
	...
	let BlockFactory = /*#__PURE__*/function () {
		...
		return babelHelpers.createClass(BlockFactory, null, [{
			key: "getInstance",
	...
	var _ActionsPopup_brand = /*#__PURE__*/new WeakSet();
	let ActionsPopup = /*#__PURE__*/function () {
		function ActionsPopup(items) {
			babelHelpers.classCallCheck(this, ActionsPopup);
			_classPrivateMethodInitSpec$1(this, _ActionsPopup_brand);
			_classPrivateFieldInitSpec$1(this, _menu, null);
			_classPrivateFieldInitSpec$1(this, _items, []);
			_classPrivateFieldInitSpec$1(this, _bindElement, null);
			_classPrivateFieldSet$1(_items, this, items);
		}
		return babelHelpers.createClass(ActionsPopup, [{
			key: "bindElement",
			value: function bindElement(_bindElement2) {
				_classPrivateFieldSet$1(_bindElement, this, _bindElement2);
				return this;
			}
		}, {
			key: "show",
			value: function show() {
				_assertClassBrand$1(_ActionsPopup_brand, this, _getMenuPopup).call(this).show();
			}
		}, {
			key: "onItemClick",
			value: function onItemClick({
				...
				if (main_core.Type.isFunction(onClick)) {
					...
					_assertClassBrand$1(_ActionsPopup_brand, this, _onClickActionItem).call(this, {
						id,
						componentId,
						componentParams
					});
	...
	function _getMenuPopup() {
		if (main_core.Type.isNil(_classPrivateFieldGet$1(_menu, this))) {
			_classPrivateFieldSet$1(_menu, this, main_popup.MenuManager.create({
				id: `crm-activity__todo-editor-v2-actions-menu_${main_core.Text.getRandom()}`,
				bindElement: _classPrivateFieldGet$1(_bindElement, this),
				autoHide: true,
				offsetLeft: 50,
				angle: true,
				closeByEsc: false,
				items: _assertClassBrand$1(_ActionsPopup_brand, this, _getPreparedItems).call(this)
			}));
		}
		return _classPrivateFieldGet$1(_menu, this);
	}
	function _getPreparedItems() {
		const result = [];
		_classPrivateFieldGet$1(_items, this).forEach(itemData => {
			if (itemData.hidden) {
				return;
			}
			result.push(_assertClassBrand$1(_ActionsPopup_brand, this, _getActionItem).call(this, itemData));
		});
		return result;
	}
	function _getActionItem(itemData) {
		const {
			svgData,
			messageCode,
			id,
		...
		return {
			html: _assertClassBrand$1(_ActionsPopup_brand, this, _getActionItemHtml).call(this, svgData, messageCode, componentParams?.isLocked),
	...
	function _getActionItemHtml(svgData, messageCode, isLocked = false) {
		return `
	...
	let TodoEditorBorderColor = /*#__PURE__*/babelHelpers.createClass(function TodoEditorBorderColor() {
	...
	var _TodoEditorV2_brand = /*#__PURE__*/new WeakSet();
	/**
	...
	let TodoEditorV2 = /*#__PURE__*/function () {
		function TodoEditorV2(_params) {
			...
			_classPrivateMethodInitSpec(this, _TodoEditorV2_brand);
			_classPrivateFieldInitSpec(this, _container, null);
			_classPrivateFieldInitSpec(this, _layoutApp, null);
			_classPrivateFieldInitSpec(this, _layoutComponent, null);
			_classPrivateFieldInitSpec(this, _loadingPromise, null);
			_classPrivateFieldInitSpec(this, _mode, TodoEditorMode.ADD);
			_classPrivateFieldInitSpec(this, _ownerTypeId, null);
			_classPrivateFieldInitSpec(this, _ownerId, null);
			_classPrivateFieldInitSpec(this, _user, null);
			_classPrivateFieldInitSpec(this, _currentUser, null);
			_classPrivateFieldInitSpec(this, _pingSettings, null);
			_classPrivateFieldInitSpec(this, _copilotSettings, null);
			_classPrivateFieldInitSpec(this, _colorSettings, null);
			_classPrivateFieldInitSpec(this, _calendarSettings, null);
			_classPrivateFieldInitSpec(this, _defaultTitle, null);
			_classPrivateFieldInitSpec(this, _defaultDescription, null);
			_classPrivateFieldInitSpec(this, _deadline, null);
			_classPrivateFieldInitSpec(this, _parentActivityId, null);
			_classPrivateFieldInitSpec(this, _borderColor, '');
			_classPrivateFieldInitSpec(this, _activityId, null);
			_classPrivateFieldInitSpec(this, _eventEmitter, null);
			_classPrivateFieldInitSpec(this, _popupMode, false);
			_classPrivateFieldInitSpec(this, _hiddenActionItems, []);
			_classPrivateFieldInitSpec(this, _actionsPopup, null);
			_classPrivateFieldInitSpec(this, _analytics, null);
			_classPrivateFieldInitSpec(this, _textEditor, null);
			_assertClassBrand(_TodoEditorV2_brand, this, _checkParams).call(this, _params);
			_assertClassBrand(_TodoEditorV2_brand, this, _initParams).call(this, _params);
			_assertClassBrand(_TodoEditorV2_brand, this, _prepareContainer).call(this);
			this.onUpdateHandler = this.onUpdateHandler.bind(this);
			this.onRepeatHandler = this.onRepeatHandler.bind(this);
			_assertClassBrand(_TodoEditorV2_brand, this, _bindEvents).call(this, _params);
		}
		return babelHelpers.createClass(TodoEditorV2, [{
			key: "setMode",
			value: function setMode(mode) {
				...
				if (_classPrivateFieldGet(_layoutComponent, this)) {
					_classPrivateFieldGet(_layoutComponent, this).setMode(mode);
				}
				return this;
			}
		}, {
			key: "show",
			value: function show() {
				_classPrivateFieldSet(_layoutApp, this, ui_vue3.BitrixVue.createApp(TodoEditor, {
					deadline: _classPrivateFieldGet(_deadline, this),
					defaultTitle: _classPrivateFieldGet(_defaultTitle, this),
					currentUser: _classPrivateFieldGet(_currentUser, this),
					pingSettings: _classPrivateFieldGet(_pingSettings, this),
					colorSettings: _classPrivateFieldGet(_colorSettings, this),
					actionsPopup: _assertClassBrand(_TodoEditorV2_brand, this, _getActionsPopup).call(this),
					blocks: _assertClassBrand(_TodoEditorV2_brand, this, _getBlocks).call(this),
					mode: _classPrivateFieldGet(_mode, this),
					analytics: _assertClassBrand(_TodoEditorV2_brand, this, _getAnalyticsInstance).call(this),
					textEditor: this.getTextEditor(),
					itemIdentifier: {
						entityTypeId: _classPrivateFieldGet(_ownerTypeId, this),
						entityId: _classPrivateFieldGet(_ownerId, this)
					}
				}));
				_classPrivateFieldSet(_layoutComponent, this, _classPrivateFieldGet(_layoutApp, this).mount(_classPrivateFieldGet(_container, this)));
			}
		}, {
			key: "getTextEditor",
			value: function getTextEditor() {
				if (_classPrivateFieldGet(_textEditor, this) !== null) {
					return _classPrivateFieldGet(_textEditor, this);
				}
				_classPrivateFieldSet(_textEditor, this, new ui_textEditor.BasicEditor({
					removePlugins: ['BlockToolbar'],
					minHeight: 50,
					maxHeight: _classPrivateFieldGet(_popupMode, this) ? 126 : 600,
					content: _classPrivateFieldGet(_defaultDescription, this),
					placeholder: main_core.Loc.getMessage('CRM_ACTIVITY_TODO_ADD_PLACEHOLDER_ROLLED'),
					paragraphPlaceholder: main_core.Loc.getMessage(main_core.Type.isPlainObject(_classPrivateFieldGet(_copilotSettings, this)) ? 'CRM_ACTIVITY_TODO_ADD_PLACEHOLDER_WITH_COPILOT_MSGVER_1' : null, crm_ai_nameService.NameService.copilotNameReplacement()),
					toolbar: [],
					floatingToolbar: ['bold', 'italic', 'underline', 'strikethrough', '|', 'link', 'copilot'],
					collapsingMode: true,
					copilot: {
						copilotOptions: main_core.Type.isPlainObject(_classPrivateFieldGet(_copilotSettings, this)) ? _classPrivateFieldGet(_copilotSettings, this) : null,
						triggerBySpace: true
					},
					events: {
						onFocus: () => {
							_assertClassBrand(_TodoEditorV2_brand, this, _onInputFocus).call(this);
						},
						onEmptyContentToggle: event => {
							_classPrivateFieldGet(_eventEmitter, this).emit('onEmptyContentToggle', {
								isEmpty: event.getData().isEmpty
							});
						},
						onCollapsingToggle: event => {
							_classPrivateFieldGet(_eventEmitter, this).emit('onCollapsingToggle', {
								isOpen: event.getData().isOpen
							});
						},
						onMetaEnter: () => {
							_assertClassBrand(_TodoEditorV2_brand, this, _onSaveHotkeyPressed).call(this);
						}
					}
				}));
				return _classPrivateFieldGet(_textEditor, this);
			...
			value: async function onUpdateHandler(event) {
				const canShowPrefilledComponent = await _assertClassBrand(_TodoEditorV2_brand, this, _canShowPrefilledComponent).call(this);
				...
				const {
					entityData,
					blocksData
				} = await _assertClassBrand(_TodoEditorV2_brand, this, _getUpdateOrRepeatActionData).call(this, event.getData());
				this.setActivityId(entityData.id).setCurrentUser(entityData.currentUser);
				await _assertClassBrand(_TodoEditorV2_brand, this, _showPrefilledComponent).call(this, entityData, blocksData, TodoEditorMode.UPDATE);
			}
		}, {
			key: "onRepeatHandler",
			value: async function onRepeatHandler(event) {
				...
				_assertClassBrand(_TodoEditorV2_brand, this, _setActiveMenuBarItem).call(this);
				this.setActivityId(null).setCurrentUser(entityData.currentUser).setDefaultDeadLine();
				entityData.deadline = _classPrivateFieldGet(_deadline, this);
				const calendar = blocksData?.find(blockData => blockData.id === 'calendar');
				if (main_core.Type.isObject(calendar)) {
					calendar.data.from = _classPrivateFieldGet(_deadline, this).getTime();
				}
				await _assertClassBrand(_TodoEditorV2_brand, this, _showPrefilledComponent).call(this, entityData, blocksData, TodoEditorMode.COPY);
			}
		}, {
			key: "save",
			value: function save() {
				if (_classPrivateFieldGet(_loadingPromise, this)) {
					return _classPrivateFieldGet(_loadingPromise, this);
				}

				// wrap BX.Promise in native js promise
				_classPrivateFieldSet(_loadingPromise, this, new Promise((resolve, reject) => {
					_assertClassBrand(_TodoEditorV2_brand, this, _getSaveActionData).call(this).then(data => {
						const analytics = _assertClassBrand(_TodoEditorV2_brand, this, _getAnalyticsLabel).call(this, data);
						main_core.ajax.runAction(_assertClassBrand(_TodoEditorV2_brand, this, _getSaveActionPath).call(this), {
							data,
							analytics
						}).then(response => {
							_classPrivateFieldSet(_currentUser, this, _classPrivateFieldGet(_user, this));
							resolve(response);
						}).catch(reject);
					}).catch(reject);
				}).catch(response => {
					...
					_classPrivateFieldSet(_loadingPromise, this, null);
				}));
				return _classPrivateFieldGet(_loadingPromise, this);
			}
		}, {
			...
			value: function getDeadline() {
				return _classPrivateFieldGet(_layoutComponent, this)?.getData().deadline ?? null;
			}
		}, {
			key: "getDescription",
			...
			value: function setParentActivityId(activityId) {
				_classPrivateFieldSet(_parentActivityId, this, activityId);
				return this;
			}
		}, {
			key: "setActivityId",
			value: function setActivityId(activityId) {
				_classPrivateFieldSet(_activityId, this, activityId);
				return this;
			}
		}, {
			key: "setCurrentUser",
			...
			value: function setDeadline(deadLine) {
				...
				if (main_core.Type.isDate(value)) {
					_classPrivateFieldGet(_layoutComponent, this).setDeadline(value);
					_classPrivateFieldSet(_deadline, this, value);
				}
				return this;
			}
		}, {
			...
			value: function setDefaultDeadLine(isNeedUpdateLayout = true) {
				...
				if (main_core.Type.isDate(defaultDate)) {
					_classPrivateFieldSet(_deadline, this, defaultDate);
				} else {
					_classPrivateFieldSet(_deadline, this, new Date());
					_classPrivateFieldGet(_deadline, this).setMinutes(0);
					_classPrivateFieldGet(_deadline, this).setTime(_classPrivateFieldGet(_deadline, this).getTime() + 60 * 60 * 1000); // next hour
				}
				if (isNeedUpdateLayout) {
					_classPrivateFieldGet(_layoutComponent, this).setDeadline(_classPrivateFieldGet(_deadline, this));
				}
				return this;
			}
		}, {
			...
			value: function cancel(params = {}) {
				const animateCollapse = _assertClassBrand(_TodoEditorV2_brand, this, _shouldAnimateCollapse).call(this);
				if (params?.sendAnalytics === false) {
					this.getTextEditor().collapse(animateCollapse);
					return _assertClassBrand(_TodoEditorV2_brand, this, _clearValue).call(this);
				}
				const data = _classPrivateFieldGet(_analytics, this)?.getData();
			...
			value: function sendAnalyticsCancelEvent(params) {
				const analytics = _assertClassBrand(_TodoEditorV2_brand, this, _getAnalyticsInstance).call(this, params);
				if (analytics === null) {
					return;
				}
			...
			value: function resetToDefaults() {
				this.setDescription(_assertClassBrand(_TodoEditorV2_brand, this, _getDefaultDescription).call(this));
				this.getTextEditor().collapse(_assertClassBrand(_TodoEditorV2_brand, this, _shouldAnimateCollapse).call(this));
				return _assertClassBrand(_TodoEditorV2_brand, this, _clearData).call(this);
			}
		}]);
	}();
	_TodoEditorV = TodoEditorV2;
	...
	function _initParams(params) {
		_classPrivateFieldSet(_container, this, params.container);
		_classPrivateFieldSet(_borderColor, this, _assertClassBrand(_TodoEditorV2_brand, this, _isValidBorderColor).call(this, params.borderColor) ? params.borderColor : _TodoEditorV.BorderColor.DEFAULT);
		_classPrivateFieldSet(_ownerTypeId, this, params.ownerTypeId);
		_classPrivateFieldSet(_ownerId, this, params.ownerId);
		_classPrivateFieldSet(_currentUser, this, params.currentUser);
		_classPrivateFieldSet(_user, this, main_core.Runtime.clone(params.currentUser));
		_classPrivateFieldSet(_pingSettings, this, params.pingSettings || {});
		_classPrivateFieldSet(_copilotSettings, this, params.copilotSettings || null);
		_classPrivateFieldSet(_colorSettings, this, params.colorSettings);
		_classPrivateFieldSet(_calendarSettings, this, params.calendarSettings || {});
		_classPrivateFieldSet(_defaultTitle, this, _assertClassBrand(_TodoEditorV2_brand, this, _getDefaultTitle).call(this));
		_classPrivateFieldSet(_defaultDescription, this, main_core.Type.isString(params.defaultDescription) ? params.defaultDescription : _assertClassBrand(_TodoEditorV2_brand, this, _getDefaultDescription).call(this));
		_classPrivateFieldSet(_deadline, this, main_core.Type.isDate(params.deadline) ? params.deadline : null);
		if (!_classPrivateFieldGet(_deadline, this)) {
			this.setDefaultDeadLine(false);
		}
		if (main_core.Type.isArrayFilled(params.actionMenuSettings?.hiddenActionItems)) {
			_classPrivateFieldSet(_hiddenActionItems, this, params.actionMenuSettings.hiddenActionItems);
		}
		_classPrivateFieldSet(_popupMode, this, main_core.Type.isBoolean(params.popupMode) ? params.popupMode : false);
		if (main_core.Type.isPlainObject(params.analytics)) {
			_classPrivateFieldSet(_analytics, this, Analytics.createFromToDoEditorData({
				analyticSection: params.analytics.section,
				analyticSubSection: params.analytics.subSection
			}));
		}
	}
	function _prepareContainer() {
		main_core.Dom.addClass(_classPrivateFieldGet(_container, this), _assertClassBrand(_TodoEditorV2_brand, this, _getClassname).call(this));
	}
	function _getActionsPopup() {
		if (_classPrivateFieldGet(_actionsPopup, this) === null) {
			const items = [{
				id: 'calendar',
				...
				hidden: !_assertClassBrand(_TodoEditorV2_brand, this, _canUseCalendarBlock).call(this)
			},
			// temporary commented
			// {
			// 	id: 'slot',
			...
			// },
			{
				...
				hidden: !_assertClassBrand(_TodoEditorV2_brand, this, _canUseAddressBlock).call(this)
			}, {
				id: 'room',
				...
				componentParams: {
					showLocation: true,
					isLocked: !_assertClassBrand(_TodoEditorV2_brand, this, _isLocationFeatureEnabled).call(this)
				},
				hidden: !_assertClassBrand(_TodoEditorV2_brand, this, _canUseAddressBlock).call(this) || !_assertClassBrand(_TodoEditorV2_brand, this, _canUseCalendarBlock).call(this)
			}, {
				type: 'delimiter',
				hidden: !_assertClassBrand(_TodoEditorV2_brand, this, _canUseAddressBlock).call(this) || !_assertClassBrand(_TodoEditorV2_brand, this, _canUseCalendarBlock).call(this)
			}, {
			...
			_assertClassBrand(_TodoEditorV2_brand, this, _prepareActionItems).call(this, items);
			_classPrivateFieldSet(_actionsPopup, this, new ActionsPopup(items));
		}
		return _classPrivateFieldGet(_actionsPopup, this);
	}
	function _prepareActionItems(items) {
		items.forEach(item => {
			// eslint-disable-next-line no-param-reassign
			item.hidden = item.id && _classPrivateFieldGet(_hiddenActionItems, this).includes(item.id) || item.hidden;
		});
	}
	function _bindEvents(params) {
		_classPrivateFieldSet(_eventEmitter, this, new main_core_events.EventEmitter());
		_classPrivateFieldGet(_eventEmitter, this).setEventNamespace('Crm.Activity.TodoEditor');
		if (main_core.Type.isObject(params.events)) {
			Object.keys(params.events).forEach(eventName => {
				if (main_core.Type.isFunction(params.events[eventName])) {
					_classPrivateFieldGet(_eventEmitter, this).subscribe(eventName, params.events[eventName]);
				}
			});
		}
	...
	async function _canShowPrefilledComponent() {
		if (main_core.Dom.hasClass(_classPrivateFieldGet(_container, this), '--is-edit')) {
			return new Promise(resolve => {
	...
	function _setActiveMenuBarItem() {
		const menuBar = BX.Crm?.Timeline?.MenuBar?.getDefault();
		if (menuBar) {
			menuBar.setActiveItemById('todo');
		}
	}
	async function _getUpdateOrRepeatActionData(data) {
		const {
			activityId,
			ownerTypeId,
			ownerId
		...
		} = await _assertClassBrand(_TodoEditorV2_brand, this, _fetchSettings).call(this, {
			id: activityId,
			ownerTypeId,
			ownerId
		});
	...
	async function _showPrefilledComponent(entityData, blocksData, mode = TodoEditorMode.ADD) {
		await _assertClassBrand(_TodoEditorV2_brand, this, _initLayoutComponentForEdit).call(this, entityData, blocksData);
		this.getTextEditor().expand();
		_assertClassBrand(_TodoEditorV2_brand, this, _scrollToTop).call(this);
		this.setMode(mode);
		this.setFocused();
	}
	async function _initLayoutComponentForEdit(entityData, blocksData) {
		return new Promise(resolve => {
			void _assertClassBrand(_TodoEditorV2_brand, this, _clearValue).call(this).then(() => {
				_classPrivateFieldGet(_layoutComponent, this).setData(entityData);
				blocksData.forEach(({
					id,
					data
				}) => {
					...
					_classPrivateFieldGet(_layoutComponent, this).setBlockFilledValues(id, data);
					_classPrivateFieldGet(_layoutComponent, this).setBlockActive(id);
				});
				resolve();
			});
		});
	...
	async function _fetchSettings({
		...
		return new Promise(resolve => {
			main_core.ajax.runAction(_assertClassBrand(_TodoEditorV2_brand, this, _getConfigActionPath).call(this), {
				data
	...
	function _getConfigActionPath() {
		return 'crm.activity.todo.fetchSettings';
	}
	function _getSaveActionData() {
		return new Promise(resolve => {
			void _assertClassBrand(_TodoEditorV2_brand, this, _getSaveActionDataSettings).call(this).then(settings => {
				const userData = _classPrivateFieldGet(_layoutComponent, this).getData();
				const data = {
					ownerTypeId: _classPrivateFieldGet(_ownerTypeId, this),
					ownerId: _classPrivateFieldGet(_ownerId, this),
					...
					parentActivityId: _classPrivateFieldGet(_parentActivityId, this),
					settings,
					pingOffsets: userData.pingOffsets,
					colorId: userData.colorId,
					isCalendarSectionChanged: userData.isCalendarSectionChanged
				};
				if (_classPrivateFieldGet(_mode, this) === TodoEditorMode.UPDATE) {
					data.id = _classPrivateFieldGet(_activityId, this);
				} else if (_classPrivateFieldGet(_mode, this) === TodoEditorMode.COPY) {
					data.isCopy = true;
				}
				resolve(data);
			});
	...
	function _getSaveActionPath() {
		return _classPrivateFieldGet(_mode, this) === TodoEditorMode.UPDATE ? 'crm.activity.todo.update' : 'crm.activity.todo.add';
	}
	function _getSaveActionDataSettings() {
		const result = _classPrivateFieldGet(_layoutComponent, this).getExecutedBlocksData();
		return Promise.resolve(result);
	}
	function _getAnalyticsLabel(data) {
		const analyticsLabel = _assertClassBrand(_TodoEditorV2_brand, this, _getAnalyticsInstance).call(this);
		...
		const defaultOffsets = _classPrivateFieldGet(_pingSettings, this).selectedValues;
		...
		if (_classPrivateFieldGet(_defaultTitle, this) !== data.title) {
			analyticsLabel.setIsTitleChanged();
		}
		if (_classPrivateFieldGet(_defaultDescription, this) !== data.description && main_core.Type.isStringFilled(data.description)) {
	...
	function _getBlocks() {
		const blocks = [];
		if (_assertClassBrand(_TodoEditorV2_brand, this, _canUseCalendarBlock).call(this)) {
			blocks.push(_assertClassBrand(_TodoEditorV2_brand, this, _getCalendarBlockSettings).call(this));
		}
		blocks.push(_assertClassBrand(_TodoEditorV2_brand, this, _getClientBlockSettings).call(this), _assertClassBrand(_TodoEditorV2_brand, this, _getLinkBlockSettings).call(this), _assertClassBrand(_TodoEditorV2_brand, this, _getFileBlockSettings).call(this));
		if (_assertClassBrand(_TodoEditorV2_brand, this, _canUseAddressBlock).call(this)) {
			blocks.push(_assertClassBrand(_TodoEditorV2_brand, this, _getAddressBlockSettings).call(this));
		}
		return blocks;
	}
	function _getCalendarBlockSettings() {
		return {
			...
			settings: _classPrivateFieldGet(_calendarSettings, this)
		};
	}
	function _getClientBlockSettings() {
		return {
	...
	function _getLinkBlockSettings() {
		return {
	...
	function _getFileBlockSettings() {
		return {
	...
	function _getAddressBlockSettings() {
		return {
	...
	function _clearValue() {
		_classPrivateFieldSet(_parentActivityId, this, null);
		return _assertClassBrand(_TodoEditorV2_brand, this, _clearData).call(this);
	}
	function _shouldAnimateCollapse() {
		const menuBar = BX.Crm?.Timeline?.MenuBar?.getDefault();
	...
	function _clearData() {
		...
		_classPrivateFieldGet(_layoutComponent, this).resetTitleAndDescription();
		_classPrivateFieldGet(_layoutComponent, this).resetPingOffsetsToDefault();
		_classPrivateFieldGet(_layoutComponent, this).resetResponsibleUserToDefault(_classPrivateFieldGet(_currentUser, this));
		_classPrivateFieldGet(_layoutComponent, this).resetColorSelectorToDefault();
		_classPrivateFieldGet(_layoutComponent, this).resetCurrentActivityId();
		main_core.Dom.removeClass(_classPrivateFieldGet(_container, this), '--is-edit');
		_classPrivateFieldGet(_layoutComponent, this).closeBlocks();
		return new Promise(resolve => {
	...
	function _getDefaultDescription() {
		...
		if (_classPrivateFieldGet(_ownerTypeId, this) === BX.CrmEntityType.enumeration.deal) {
	...
	function _onInputFocus() {
		main_core.Dom.addClass(_classPrivateFieldGet(_container, this), '--is-edit');
		_classPrivateFieldGet(_eventEmitter, this).emit('onFocus');
	}
	function _onSaveHotkeyPressed() {
		_classPrivateFieldGet(_eventEmitter, this).emit('onSaveHotkeyPressed');
	}
	function _isValidBorderColor(borderColor) {
		return main_core.Type.isString(borderColor) && _TodoEditorV.BorderColor[borderColor.toUpperCase()];
	}
	function _getClassname() {
		return `crm-activity__todo-editor-v2 --border-${_classPrivateFieldGet(_borderColor, this)}`;
	}
	function _isLocationFeatureEnabled() {
		return main_core.Extension.getSettings('crm.activity.todo-editor-v2').get('locationFeatureEnabled');
	}
	/**
	 * @event onFocus
