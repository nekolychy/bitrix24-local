...
if (
	...
	|| \Bitrix\Ui\Public\Enum\IconSet\Outline::tryFrom('o-sick') == null
)
{
	return;
}
...
$arActivityDescription =
	(new ActivityDescription(
		(string)Loc::getMessage('TIMEMAN_ABSENCE_LEAVE_SICK_NAME'),
		(string)Loc::getMessage('TIMEMAN_ABSENCE_LEAVE_SICK_DESCR'),
		...
		->setReturn([
			...
			'ACTIVE_FROM' => [
				'Name' => (string)Loc::getMessage('TIMEMAN_ABSENCE_LEAVE_RETURN_FIELD_ACTIVE_FROM'),
				'Type' => FieldType::DATETIME,
			],
			'ACTIVE_TO' => [
				'Name' => (string)Loc::getMessage('TIMEMAN_ABSENCE_LEAVE_RETURN_FIELD_ACTIVE_TO'),
				'Type' => FieldType::DATETIME,
			],
		])
		->setIcon(Outline::SICK->name)
